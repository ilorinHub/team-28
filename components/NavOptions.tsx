...
export type PlanTripProp = NativeStackNavigationProp<StackList, "PlanTrip">;
export type ShortestPathProp = NativeStackNavigationProp<StackList, "ShortestPath">;
export type WalletProp = NativeStackNavigationProp<StackList, "Wallet">;
